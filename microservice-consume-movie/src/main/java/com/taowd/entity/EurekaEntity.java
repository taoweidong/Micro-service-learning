...
public class EurekaEntity {
     ...
     * metadata : {"$ref":"$.instanceInfo.metadata"} port : 9105 secure : false serviceId : MICROSERVICE-CONSUME-MOVIE
     * uri : http://192.168.1.103:9105
     */
    private String host;
    ...
    public static class InstanceInfoBean {
        ...
        /**
         * actionType : ADDED appName : MICROSERVICE-CONSUME-MOVIE coordinatingDiscoveryServer : false countryId : 1
         * dataCenterInfo : {"name":"MyOwn"} dirty : false healthCheckUrl : http://192.168.1.103:9105/actuator/health
         * healthCheckUrls : ["http://192.168.1.103:9105/actuator/health"] homePageUrl : http://192.168.1.103:9105/
         * hostName : 192.168.1.103 iPAddr : 192.168.1.103 id : DESKTOP-H5QV6OP:microservice-consume-movie:9105
         * instanceId : DESKTOP-H5QV6OP:microservice-consume-movie:9105 lastDirtyTimestamp : 1578233522237
         ...
         * metadata : {"management.port":"9105"} overriddenStatus : UNKNOWN port : 9105 sID : na securePort : 443
         * secureVipAddress : microservice-consume-movie status : UP statusPageUrl :
         * http://192.168.1.103:9105/actuator/info vIPAddress : microservice-consume-movie version : unknown
         */
        ...
        public static class LeaseInfoBean {
            ...
            /**
             * durationInSecs : 90 evictionTimestamp : 0 registrationTimestamp : 1578233522353 renewalIntervalInSecs :
             * 30 renewalTimestamp : 1578233522353 serviceUpTimestamp : 1578233521841
             */
